...
uint8_t button_getButton() {
    ...
    //Button - SW6
    if ((GPIO_PORTE_DATA_R & 0b00100000) == 0b00000000) return 6;

    //Button - SW5
    else if ((GPIO_PORTE_DATA_R & 0b00010000) == 0b00000000) return 5;

    //Button - SW4
    else if ((GPIO_PORTE_DATA_R & 0b00001000) == 0b00000000) return 4;

    //Button - SW3
    else if ((GPIO_PORTE_DATA_R & 0b00000100) == 0b00000000) return 3;

    //Button - SW2
    else if ((GPIO_PORTE_DATA_R & 0b00000010) == 0b00000000) return 2;

    //Button - SW1
    else if ((GPIO_PORTE_DATA_R & 0b00000001) == 0b00000000) return 1;
